...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step4.port_time'
        db.add_column('carsales_step4', 'port_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Step4.port_second_time'
        db.add_column('carsales_step4', 'port_second_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Step4.port_time'
        db.delete_column('carsales_step4', 'port_time')

        # Deleting field 'Step4.port_second_time'
        db.delete_column('carsales_step4', 'port_second_time')
