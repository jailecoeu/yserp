...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Step5'
        db.create_table('carsales_step5', (
            ...
            ('devanning_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('devanning_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='devanning_registrant', null=True, to=orm['auth.User'])),
            ('show_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('show_room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Showroom'], null=True, blank=True)),
            ('show_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='show_registrant', null=True, to=orm['auth.User'])),
            ('obd_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('obd_no', self.gf('django.db.models.fields.CharField')(default=u'', max_length=30, blank=True)),
            ('obd_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='obd_registrant', null=True, to=orm['auth.User'])),
            ('sn_time', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('sn_remark', self.gf('django.db.models.fields.TextField')(default=u'')),
            ('sn_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sn_registrant', null=True, to=orm['auth.User'])),
            ('out_tax_money', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('out_tax_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('out_tax_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='out_tax_registrant', null=True, to=orm['auth.User'])),
            ('mat_tax_agency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mat_tax_agency', null=True, to=orm['system.Agency'])),
            ('mat_tax_money', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('real_tax_money', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('real_tax_obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Agency'], null=True, blank=True)),
            ('real_tax_time', self.gf('django.db.models.fields.DateField')(null=True)),
            ('real_tax_remark', self.gf('django.db.models.fields.TextField')(default=u'')),
            ('real_tax_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='real_tax_registrant', null=True, to=orm['auth.User'])),
            ('customer_tax_money', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('customer_tax_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
            ('customer_tax_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='customer_tax_registrant', null=True, to=orm['auth.User'])),
            ('pdi_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('pdi_agency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pdi_agency', null=True, to=orm['system.Agency'])),
            ('pdi_remark', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('pdi_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pdi_registrant', null=True, to=orm['auth.User'])),
            ('end_tax_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('end_tax_remark', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('end_tax_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='end_tax_registrant', null=True, to=orm['auth.User'])),
            ('end_money', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('end_money_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='end_money_registrant', null=True, to=orm['auth.User'])),
            ('end_real_pay_money', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('end_real_pay_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('end_need_pay_money', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('end_pay_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='end_pay_registrant', null=True, to=orm['auth.User'])),
            ('release_time', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('release_remark', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('release_registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_registrant', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('carsales', ['Step5'])


        # Changing field 'Step3.port_plan_start'
        db.alter_column('carsales_step3', 'port_plan_start_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step3.bill_agency'
        db.alter_column('carsales_step3', 'bill_agency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Agency'], null=True))

        # Changing field 'Step3.bill_pay_registrant'
        db.alter_column('carsales_step3', 'bill_pay_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Step3.port_real_start'
        db.alter_column('carsales_step3', 'port_real_start_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step3.port_plan_end'
        db.alter_column('carsales_step3', 'port_plan_end_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step3.real_registrant'
        db.alter_column('carsales_step3', 'real_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Step3.bill_registrant'
        db.alter_column('carsales_step3', 'bill_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Step3.port_real_end'
        db.alter_column('carsales_step3', 'port_real_end_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step3.bill_pay_obj'
        db.alter_column('carsales_step3', 'bill_pay_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Customer'], null=True))

        # Changing field 'Step4.port_end'
        db.alter_column('carsales_step4', 'port_end_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step4.port_start'
        db.alter_column('carsales_step4', 'port_start_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Port']))

        # Changing field 'Step4.port_registrant'
        db.alter_column('carsales_step4', 'port_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'Step5'
        db.delete_table('carsales_step5')


        # Changing field 'Step3.port_plan_start'
        db.alter_column('carsales_step3', 'port_plan_start_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step3.bill_agency'
        db.alter_column('carsales_step3', 'bill_agency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Agency']))

        # Changing field 'Step3.bill_pay_registrant'
        db.alter_column('carsales_step3', 'bill_pay_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Step3.port_real_start'
        db.alter_column('carsales_step3', 'port_real_start_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step3.port_plan_end'
        db.alter_column('carsales_step3', 'port_plan_end_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step3.real_registrant'
        db.alter_column('carsales_step3', 'real_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Step3.bill_registrant'
        db.alter_column('carsales_step3', 'bill_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Step3.port_real_end'
        db.alter_column('carsales_step3', 'port_real_end_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step3.bill_pay_obj'
        db.alter_column('carsales_step3', 'bill_pay_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Customer']))

        # Changing field 'Step4.port_end'
        db.alter_column('carsales_step4', 'port_end_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step4.port_start'
        db.alter_column('carsales_step4', 'port_start_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Port']))

        # Changing field 'Step4.port_registrant'
        db.alter_column('carsales_step4', 'port_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
