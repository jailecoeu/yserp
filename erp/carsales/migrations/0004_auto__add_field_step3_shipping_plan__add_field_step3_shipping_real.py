...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step3.shipping_plan'
        db.add_column('carsales_step3', 'shipping_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_plan', null=True, to=orm['system.Agency']),
                      keep_default=False)

        # Adding field 'Step3.shipping_real'
        db.add_column('carsales_step3', 'shipping_real',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_real', null=True, to=orm['system.Shipping']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Step3.shipping_plan'
        db.delete_column('carsales_step3', 'shipping_plan_id')

        # Deleting field 'Step3.shipping_real'
        db.delete_column('carsales_step3', 'shipping_real_id')
