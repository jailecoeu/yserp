...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step4.shipping_money_registrant'
        db.add_column('carsales_step4', 'shipping_money_registrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_money_registrant', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Step4.shipping_money_registrant'
        db.delete_column('carsales_step4', 'shipping_money_registrant_id')
