...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Step2.agency'
        db.alter_column('carsales_step2', 'agency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Agency'], null=True))

        # Changing field 'Step2.issue_registrant'
        db.alter_column('carsales_step2', 'issue_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Step2.issue_pay_obj'
        db.alter_column('carsales_step2', 'issue_pay_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Customer'], null=True))

        # Changing field 'Step2.issue_pay_registrant'
        db.alter_column('carsales_step2', 'issue_pay_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Step2.agency'
        db.alter_column('carsales_step2', 'agency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Agency']))

        # Changing field 'Step2.issue_registrant'
        db.alter_column('carsales_step2', 'issue_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Step2.issue_pay_obj'
        db.alter_column('carsales_step2', 'issue_pay_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Customer']))

        # Changing field 'Step2.issue_pay_registrant'
        db.alter_column('carsales_step2', 'issue_pay_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
