...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Step3.plan_registrant'
        db.alter_column('carsales_step3', 'plan_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Step3.plan_registrant'
        db.alter_column('carsales_step3', 'plan_registrant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
