...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Step3.order_no'
        db.delete_column('carsales_step3', 'order_no')

        # Adding field 'Step3.lading_no'
        db.add_column('carsales_step3', 'lading_no',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Step3.order_no'
        db.add_column('carsales_step3', 'order_no',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True),
                      keep_default=False)

        # Deleting field 'Step3.lading_no'
        db.delete_column('carsales_step3', 'lading_no')
