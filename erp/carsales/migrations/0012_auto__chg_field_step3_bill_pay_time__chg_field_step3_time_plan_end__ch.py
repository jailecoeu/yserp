...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Step3.bill_pay_time'
        db.alter_column('carsales_step3', 'bill_pay_time', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.time_plan_end'
        db.alter_column('carsales_step3', 'time_plan_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.time_real_end'
        db.alter_column('carsales_step3', 'time_real_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.time_plan_start'
        db.alter_column('carsales_step3', 'time_plan_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.bill_time'
        db.alter_column('carsales_step3', 'bill_time', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.time_real_start'
        db.alter_column('carsales_step3', 'time_real_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Step3.bill_warning_time'
        db.alter_column('carsales_step3', 'bill_warning_time', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Step3.bill_pay_time'
        db.alter_column('carsales_step3', 'bill_pay_time', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 3, 18, 0, 0)))

        # Changing field 'Step3.time_plan_end'
        db.alter_column('carsales_step3', 'time_plan_end', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2015, 3, 18, 0, 0)))

        # Changing field 'Step3.time_real_end'
        db.alter_column('carsales_step3', 'time_real_end', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=1))

        # Changing field 'Step3.time_plan_start'
        db.alter_column('carsales_step3', 'time_plan_start', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=1))

        # Changing field 'Step3.bill_time'
        db.alter_column('carsales_step3', 'bill_time', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 3, 18, 0, 0)))

        # Changing field 'Step3.time_real_start'
        db.alter_column('carsales_step3', 'time_real_start', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=1))

        # Changing field 'Step3.bill_warning_time'
        db.alter_column('carsales_step3', 'bill_warning_time', self.gf('django.db.models.fields.DateField')(default=1))
