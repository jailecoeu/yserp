...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Step4.shipping_pay_obj'
        db.delete_column('carsales_step4', 'shipping_pay_obj_id')

        # Deleting field 'Step4.port_pay_money'
        db.delete_column('carsales_step4', 'port_pay_money')

        # Deleting field 'Step4.port_money'
        db.delete_column('carsales_step4', 'port_money')

        # Adding field 'Step4.shipping_obj'
        db.add_column('carsales_step4', 'shipping_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_obj', null=True, to=orm['system.Shipping']),
                      keep_default=False)

        # Adding field 'Step4.shipping_second_money'
        db.add_column('carsales_step4', 'shipping_second_money',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=128),
                      keep_default=False)

        # Adding field 'Step4.shipping_pay_time'
        db.add_column('carsales_step4', 'shipping_pay_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Step4.shipping_pay_registrant'
        db.add_column('carsales_step4', 'shipping_pay_registrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_pay_registrant', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Step4.shipping_second_pay_money'
        db.add_column('carsales_step4', 'shipping_second_pay_money',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Step4.shipping_second_pay_time'
        db.add_column('carsales_step4', 'shipping_second_pay_time',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Step4.shipping_second_pay_registrant'
        db.add_column('carsales_step4', 'shipping_second_pay_registrant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipping_second_pay_registrant', null=True, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Step4.shipping'
        db.alter_column('carsales_step4', 'shipping_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.Shipping']))

    def backwards(self, orm):
        # Adding field 'Step4.shipping_pay_obj'
        db.add_column('carsales_step4', 'shipping_pay_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Shipping']),
                      keep_default=False)

        # Adding field 'Step4.port_pay_money'
        db.add_column('carsales_step4', 'port_pay_money',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Step4.port_money'
        db.add_column('carsales_step4', 'port_money',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=128),
                      keep_default=False)

        # Deleting field 'Step4.shipping_obj'
        db.delete_column('carsales_step4', 'shipping_obj_id')

        # Deleting field 'Step4.shipping_second_money'
        db.delete_column('carsales_step4', 'shipping_second_money')

        # Deleting field 'Step4.shipping_pay_time'
        db.delete_column('carsales_step4', 'shipping_pay_time')

        # Deleting field 'Step4.shipping_pay_registrant'
        db.delete_column('carsales_step4', 'shipping_pay_registrant_id')

        # Deleting field 'Step4.shipping_second_pay_money'
        db.delete_column('carsales_step4', 'shipping_second_pay_money')

        # Deleting field 'Step4.shipping_second_pay_time'
        db.delete_column('carsales_step4', 'shipping_second_pay_time')

        # Deleting field 'Step4.shipping_second_pay_registrant'
        db.delete_column('carsales_step4', 'shipping_second_pay_registrant_id')


        # Changing field 'Step4.shipping'
        db.alter_column('carsales_step4', 'shipping_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['system.Shipping']))
